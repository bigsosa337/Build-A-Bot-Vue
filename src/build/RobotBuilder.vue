<template>
    ...
    <div class="middle-row">
      ...
      <div class="right part">
        <img :src="selectedRobot.rightArm
          .src" title="left arm"/>
...
export default {
  ...
  methods: {
    ...
    selectPreviousHead() {
      console.log('previousHead called');
      this.selectedHeadIndex =
    ...
    selectNextLeftArm() {
      console.log('selectNextArm called');
    ...
    selectPreviousLeftArm() {
      console.log('previousArm called');
      this.selectedLeftArmIndex =
      getPreviousValidIndex(
        this.selectedLeftArmIndex, availableParts.arms.length,
      );
    ...
    selectPreviousTorso() {
      console.log('previousTorso called');
      this.selectedTorsoIndex =
      getPreviousValidIndex(
        this.selectedTorsoIndex, availableParts.torsos.length,
      );
    ...
    selectNextBase() {
      console.log('selectNextBase called');
    ...
    selectPreviousBase() {
      console.log('previousBase called');
      this.selectedBaseIndex =
      getPreviousValidIndex(
        this.selectedBaseIndex, availableParts.bases.length,
      );
